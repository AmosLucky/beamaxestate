  ...
  ?>
                ...
                <div class="property-item " >
                  <a href="property-single.php?id=<?php echo $id ?>" class="img">
                    <img src="uploaded/images/<?=$images[0] ?>" alt="Image" class="img-fluid" />
                  </a>

                  <div class="property-content">
                    <div class="price mb-2"><span>$<?= number_format($price) ?></span></div>
                    <div>
                      ...
                      <div class="specs d-flex mb-4">
                        <span class="d-block d-flex align-items-center me-3">
                          ...
                          <span class="caption"><?=$bedrooms ?> beds</span>
                        </span>
                        <span class="d-block d-flex align-items-center">
                          <span class="icon-bath me-2"></span>
                          <span class="caption"><?=$bathrooms ?> baths</span>
                        </span>
                      </div>

                      <a
                        href="property-single.php?id=<?php echo $id ?>"
...
while($row = mysqli_fetch_array($exe)){
  ...
  ?>
                ...
                <div class="property-item col-md-4" >
                  <a href="property-single.php?id=<?php echo $id ?>" class="img">
                    <img src="uploaded/images/<?=$images[0] ?>" alt="Image" class="img-fluid" />
                  </a>
